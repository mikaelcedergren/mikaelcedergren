...
root. This describes the target artifact; the exact selected legacy wrapper retained below remains
the runtime until authorised cutover.
...
The tracked LaunchDaemon template describes the future atomic `current-server` artifact and
